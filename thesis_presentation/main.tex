...
\begin{figure}[htpb]
    ...
    \begin{tikzpicture}[node distance=4cm]
        ...
        % wrap
        \node (PD1) [cell, fill=cyan!80] {Protection Domain};
        \node (PD2) [cell, fill=green!80, right=120pt of PD1] {Protection Domain};
        ...
        \node [color=red] at (125pt, -40pt) {blocked access};
        \node [color=green!200] at (-30pt, -60pt) {good access};
