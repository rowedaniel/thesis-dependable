...
\begin{abstract}
  % citations look like \citep{ell-ht-format}.
      ...
      % TODO: from Alain: consider dropping "application"? "System application" seems redundant
      ...
      Here, we focus on the components of the network stack that constitute a particular layer: the User Datagram Protocol (UDP) layer, 
      ...
      % TODO: end highlight. from Alain: Suggested rewrite is "Here, we focus on one specific component of the network called the User Datagram Protocol (UDP) layer. Inspired by seL4 verification effort, we adopt a verification process that includes formal specifications and refinement steps proving specific relationships across these specifications.
...
% TODO: from Alain: "Reference for a study that shows bugs in file system implementation does not die down over time: Lanyue Lu et al. "A study of Linux File System Evolutiion," FAST 2013, see 6th paragraph of introduction. The handle for this entry in my bibtex database is "Lanyue2013 Study."
...
% TODO: note that in one way it eliminates the chance of human error, but also since the interactive theorem prover (ITP) may also have errors, it has problems.
...
% TODO: next paragraph wordy. Consider reorganizing
...
% TODO: Probably the best reference is "Wilde2024Network" found in my bibtex database.
...
% TODO: note that these are our terms, not standard.
endpoint, though more functionality is needed for other important processes such as
% TODO: from Alain: 'endpoint' may be dangerous to use because it may be mentioned in the Ethernet spec to mean a computjer attached to the network. 'Functionality' perhaps?
addressing.
...
\end{lstlisting}
    % TODO: from Alain: remove space before comma.
...
% TODO: note that 'endpoint' is reserved for other cases. Find a different word.
...
% TODO: from the father: "I feel like it would be nice to explain UDP here"
...
% TODO: from the father: "are there extra parenthesis associated with citations that need to be removed?"
will likely be useful in this case.

% TODO: from the father: I suggest a new section here called "This work" or "Project Goals" or some such. Here say this: The goal of this thesis is to provide proofs and definitions for the UDP layer. Specifically, our goal is to show that given such conditions, our implementations of the UDP layer will always function correctly.

\chapter{Simplifying assumptions}
% TODO: from Alain: I'm still not in love with 'endpoints'. I'm not sure if 'functionality' is better. 'function', 'process', ...?
\section{State}
...
% TODO: from Alain: "within that state" or "within the state"
...
% TODO: from Alain: "memory access *rights* must ..."
...
% TODO: from Alain: remove "that do not cause issues,"
...
% TODO: from Alain: UDP wrap AND UDP unwrap.
...
% TODO: from the father: "Say this in the introduction!"
layer.
...
% TODO: from Alain: missing period.
...
% TODO: reads a little odd. I'd like to have a longer paragraph, I think?
% TODO: from Alain: consider active voice? "seL4 inspired our proof architecture."
...
\begin{figure}[h]
    ...
    % TODO: from peter: In Figure 3.1, if invariants are always true for the abstract specification, and the design specification refines the abstract specification, the "refines" arrow seems like it should point the other way. This would allow someone to read the "sentence" in the order <source box> <arrow> <destination box>, and is consistent with UML class diagrams. If you wish to keep the arrows moving in this direction to show the "flow of truth", then perhaps the second arrow should be relabeled "is refined by".
\end{figure}
...
\end{nlisting}
    ...
    % TODO: we imply that UDP uses IP address, when it need not here.
\end{figure}
...
\end{lstlisting}
    \caption{The definition of UDP wrap in the abstract specification.
        ...
        % TODO: from Alain: "via THE @ operator
        \lstinline{msg}.
    }
...
% TODO: from Alain: proofs? (make it plural, you have it in plural in section 3.1 after all.)
...
% TODO: from Alain: close parenthesis
% TODO: I think Alain's wrong on this one.
...
Peano axioms, % TODO: need citation
...
% TODO: from Peter: On p. 19, the penultimate paragraph seems to end mid-sentence.
...
\chapter{Future Work}
% TODO: from Alain: lowercase 'work'
...
% TODO: from Alain: "earlier" or "in a previous chapter/section"
...
% TODO: from Alain: do you mean above on this page or in a previous section?
...
% TODO: from Alain: text for this section?
