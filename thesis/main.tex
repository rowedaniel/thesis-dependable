...
% I suggest a new section here called "This work" or "Project Goals" or some such. Here say this: The goal of this thesis is to provide proofs and definitions for the UDP layer. Specifically, our goal is to show that given such conditions, our implementations of the UDP layer will always function correctly.
